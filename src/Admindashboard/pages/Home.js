...
//   const containerStyle = {
//     width: isSidebarVisible && window.innerWidth > 600 ? '100%' : '100%',
//     transition: 'width 0.3s',
//     marginLeft: isSidebarVisible && window.innerWidth > 600 ? '0px' : '0px',
//     marginTop: '100px',
//   };
  ...
  useEffect(() => {
    const fetchPropertyData = async () => {
      ...
      try {
        ...
        const allProperties = await getDocs(propertiesRef);
        console.log("Processing", allProperties.size, "properties for weekly data");
        ...
        allProperties.forEach((doc) => {
          ...
          console.log("Property date:", propertyDate);
          
          if (propertyDate >= startOfWeek) {
            const daysDiff = Math.floor((propertyDate - startOfWeek) / (24 * 60 * 60 * 1000));
            
            if (daysDiff >= 0 && daysDiff < 7) {
              console.log("Adding property to day", daysDiff);
  ...
  return (
    <div style={containerStyle} className={styles.responsiveContainer}>
      ...
      <div className={styles.headerSection}>
        ...
        <p className={styles.pageSubtitle}>Monitor and manage your property portfolio</p>
      </div>
      ...
      <div className={styles.statsSection}>
        <div className={styles.statsGrid}>
          ...
          <div className={styles.statCard}>
            <div className={styles.statValue}>{stats.sale}</div>
      ...
      <div className={styles.chartsSection}>
        <div className={styles.chartContainer}>
          <div className={styles.chartHeader}>
            <h3 className={styles.chartTitle}>Weekly Property Statistics</h3>
            <p className={styles.chartSubtitle}>Property activity for the current week</p>
          </div>
      ...
      <div className={styles.usersSection}>
        <div className={styles.usersContainer}>
          <div className={styles.usersHeader}>
            <h3 className={styles.usersTitle}>System Administrators</h3>
            <p className={styles.usersSubtitle}>Active admin users in the system</p>
          </div>
